    ...
    <van-popup :value="show" get-container="body">
        <div class="tx-dx-searchmask">
            ...
            <div class="searchmask-con">
                ...
                <div class="item1-box">
                    <van-tag @click="jsTotag(ite.value)" round color="#f4f4f4" text-color="#58595b" v-for="ite in searchmenu" :key="ite.value">{{ite.value}}</van-tag>
                </div>
            </div>
        </div>
    </van-popup>
...
export default {
    ...
    methods:{
        ...
        onSearch(){
            ...
            that.$emit("onSearch",{opt_name: obj.opt_name,keyword:that.searchvalue,type:obj.type,class_id:obj.class_id})
